...
**Prerequisites:** Python 3.14+, [tmux](https://github.com/tmux/tmux) or [herdr](https://github.com/ogulcancelik/herdr), and one agent CLI (`claude`, `codex`, `gemini`, `kimi`, or `pi` installed and authenticated; or use `shell` with no extra install). CCGram does not modify agent SDKs.
